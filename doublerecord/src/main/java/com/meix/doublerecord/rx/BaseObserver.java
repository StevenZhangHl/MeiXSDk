package com.meix.doublerecord.rx;
...
import com.meix.doublerecord.widget.LoadingDialog;
...
public abstract class BaseObserver<T> extends DisposableObserver<T> {
    ...
    public void onError(Throwable e) {
        ...
        if (!NetWorkUtils.isNetConnected(mContext)) {
            onError(mContext.getString(R.string.error_please_check_network));
        }
        //服务器
...
//                onError("404");
//            } else {
            onError(mContext.getString(R.string.connection_network_error));
//            }
        }
        //其它(请求超时)
        else {
